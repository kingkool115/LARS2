...
namespace App\PushBots;

/**
 * PushBots.class Library v1.1b
 *
 * @category  Library
...
class PushBots
{
	...
	/**
	 * @param	string	$appId			PushBots.class Applciation Id.
	 * @param	string	$appSecret	PushBots.class Application Secret.
	 */
	...
	/**
	 * sendRequest
	 * @param	string	$host	PushBots.class API.
